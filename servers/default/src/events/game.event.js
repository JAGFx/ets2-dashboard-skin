...
export default (telemetry) => {
  ...
  telemetry.game.on(eventNames.pause, (paused) => {
  ...
  telemetry.game.on(eventNames.fine, (fine) => {
    const text = `${
      fine.offence.name
    }, ${currency()}${fine.amount.toLocaleString()} fine`;
    const data = {
      fine: fine
    };
  ...
  telemetry.game.on(eventNames.tollgate, (tollgate) => {
  ...
  telemetry.game.on(eventNames.ferry, (ferry) => {
  ...
  telemetry.game.on(eventNames.train, (train) => {
