...
export default (telemetry) => {
  telemetry.truck.on(eventNames.cruiseControl, (enabled) => {
  ...
  telemetry.truck.on(eventNames.cruiseControlIncrease, (cruiseControl) => {
  ...
  telemetry.truck.on(eventNames.cruiseControlDecrease, (cruiseControl) => {
  ...
  telemetry.truck.on(eventNames.warning, (warning, enabled) => {
    const text = enabled
      ? `Warning: ${warning}`
  ...
  telemetry.truck.on(eventNames.emergency, (emergency, enabled) => {
    const text = enabled
      ? `Emergency: ${emergency}`
  ...
  telemetry.truck.on(eventNames.electric, (enabled) => {
  ...
  telemetry.truck.on(eventNames.engine, (enabled) => {
  ...
  telemetry.truck.on(eventNames.park, (enabled) => {
  ...
  telemetry.truck.on(eventNames.damage, (damages) => {
  ...
  telemetry.truck.on(eventNames.refuel, (curr, prev) => {
