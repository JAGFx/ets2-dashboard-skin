...
export default {
  ...
  methods:  {
        ...
        const currencySymbolValue = this.getConfig( 'unit_currency' ); //this.$store.getters[ 'config/get' ]( 'unit_currency' );
        let unit                  = '';
        ...
        const length       = this.getConfig( 'unit_length' ); //this.$store.getters[ 'config/get' ]( 'unit_length' );
        ...
        const weight       = this.getConfig( 'unit_weight' ); //this.$store.getters[ 'config/get' ]( 'unit_weight' );
        ...
        const unitDefined = this.getConfig( 'unit_volume' ); //this.$store.getters[ 'config/get' ]( 'unit_volume' );
        ...
        const unitDefined = this.getConfig( 'unit_consumption' ); //this.$store.getters[ 'config/get' ]( 'unit_consumption' );
        let conversion    = null;
        ...
        const unitDefined = this.getConfig( 'unit_pressure' ); //this.$store.getters[ 'config/get' ]( 'unit_pressure' );
        ...
        const unitDefined = this.getConfig( 'unit_degrees' ); //this.$store.getters[ 'config/get' ]( 'unit_degrees' );
