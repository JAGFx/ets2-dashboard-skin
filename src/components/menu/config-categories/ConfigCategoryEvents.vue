<template>
  <div class="fields mb-4">
    ...
    />
    <!-- </editor-folder> -->
    <!-- <editor-folder> Navigation -->
    <ConfigFieldChoice
      v-bind="{
        id: 'events_navigation.speed-limit',
        label: 'Speed limit',
        disabled: false,
    ...
    />
    <!-- </editor-folder> -->
    <!-- <editor-folder> Trailers -->
    <ConfigFieldChoice
      v-bind="{
        id: 'events_trailers.coupling',
    ...
    <ConfigFieldChoice
      v-bind="{
        id: 'events_truck.cruise-control-increase',
