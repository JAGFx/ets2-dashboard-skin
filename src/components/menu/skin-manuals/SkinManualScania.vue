<template>
  <div class="overlay manual d-flex justify-content-center align-items-center">
    <div class="manual-wrapper">
      <table class="table table-striped table-dark symbols">
        ...
        <tbody>
          ...
          />
          <SkinManualLine
            :icons="['icon-scania-menu-driving-info']"
          ...
          />
          <SkinManualLine
            :icons="['icon-scania-menu-instantaneous-data']"
          ...
          />
          <SkinManualLine
            :icons="['icon-scania-menu-vehicle-info']"
