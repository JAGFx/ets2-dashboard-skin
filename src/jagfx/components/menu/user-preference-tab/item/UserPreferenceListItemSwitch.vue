<template>
  <UserPreferenceListItem>
    <Switch
      :initial-value="find(props.preferenceEntryId).value"
      @change="(value) => update(props.preferenceEntryId, value)"
    />
  </UserPreferenceListItem>
</template>
...
const props = defineProps<UserPreferenceListItemSwitchProps>();
