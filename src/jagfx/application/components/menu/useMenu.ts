...
import CompleteNavbar from '@/jagfx/application/components/navbar/CompleteNavbar.vue';
import DiscreteNavbar from '@/jagfx/application/components/navbar/DiscreteNavbar.vue';
